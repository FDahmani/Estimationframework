...
simulation_start_epoch = time_conversion.DateTime(1980,1,1,12,0,0).epoch()
...
jovian_moons_to_create = ['Io', 'Europa', 'Ganymede', 'Callisto','Himalia']
...
initial_states = [ 3.63053066e+09,  9.37120090e+09, -2.05733444e+09, -2.70456039e+03,  1.99809290e+03,  1.50790352e+03] #1980
### Integrator Settings ###
...
link_ends_himalia = dict()
link_ends_himalia[estimation_setup.observation.observed_body] = estimation_setup.observation.\
    body_origin_link_end_id('Himalia')
link_definition_himalia = estimation_setup.observation.LinkDefinition(link_ends_himalia)

link_definition_dict = {
    'Himalia': link_definition_himalia,
}


### Observation Model Settings

position_observation_settings = [estimation_setup.observation.cartesian_position(link_definition_himalia)]
...
n = len(np.linalg.norm(position_difference['Himalia'], axis=1))
fft_result = np.fft.fft(np.linalg.norm(position_difference['Himalia'], axis=1))
